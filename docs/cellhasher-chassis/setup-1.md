...
Head to [Enabling USB (and Wireless) Debugging](../additional-docs/enabling-usb-and-wireless-debugging.md) and complete this process for your phones.
