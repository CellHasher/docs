...
:::warning
**Note for Xiaomi, Redmi, and similar devices:**\
...
:::warning
When multiple Cellhasher connections to one PC, your PC may fail to manage all the USB devices. are powered and recognized by Windows before proceeding.
:::
...
Share your set up with the links below and head to [Set-Up (Download)](../cellhasher-control/set-up-download.md) to start controlling your phones! 

<a href="https://x.com/CellHasher" className="button button--secondary">Follow Cellhasher on X</a> <a href="https://discord.com/invite/9bGE6e4X2c" className="button button--secondary">Join us on Discord</a>
