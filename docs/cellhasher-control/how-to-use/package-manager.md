...
* Add Package: Curate your own package removal list.
* Remove: Select individual packages to remove them from the list.
* Reset: Generates the original custom list again.
* Save & Close
